...
namespace Soledad_Cabrera_Taller_1_deportes.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(Soledad_Cabrera_Taller_1_deportesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Dieccion,Ciudad,Capacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dieccion,Ciudad,Capacidad")] Estadio estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
